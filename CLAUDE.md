...
| 10     | Flask decommission — only after FastAPI parity audit (10A → **KEEP Flask**; 10B create+browse done; gaps UI/config-write/glossary-review remain) |       5/10 | 🟡 Medium    | 🟡      |
