...
- **Sprint 11 (active) — FastAPI UI functional parity:**
  ...
  - **11C glossary/character/TM/provider config → next stage**
...
**Validation baseline (Gate 11B-3):** 668 tests / 4 skipped · pyright 0 · ruff + format clean · Flask 13 routes (`/`→200) · FastAPI 70 route objects · CLI 15 commands.
