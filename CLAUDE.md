...
- **Sprint 12 (next) ⏳** — FastAPI UI parity audit + default-`serve` decision. Then Sprint 13 — Flask decommission (only if 12 passes **and** explicitly approved).
...
**Validation baseline (Gate 11C):** 683 tests / 4 skipped · pyright 0 · ruff + format clean · Flask 13 routes (`/`→200) · FastAPI 87 route objects · CLI 15 commands.
